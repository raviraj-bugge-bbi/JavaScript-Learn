...
function jsonFile (){
  ...
  document.getElementById("jsondata").innerHTML = `First Name: ${userDetails["First Name"]} \n Last Name: ${userDetails["Last Name"]}  Contact No.: ${userDetails["Contact No:"]}  Email: ${userDetails.Email}`;
}
