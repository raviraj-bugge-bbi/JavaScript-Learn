...
console.log(`${jonas.firstName} is a ${jonas.age()} year old ${jonas.job} and he ${jonas.hadDriverLicense()} drivers license.`);
...
const myCountry1 = {
    ...
    checkIsland : function (){
        this.isIsland = [this.neighbours.length == 0 ? "is island" : "is not island"];
